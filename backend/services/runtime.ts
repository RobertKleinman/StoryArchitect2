...
export const activeModelConfig: ModelConfig = {
  ...
  grounding_researcher: envModel("GROUNDING_MODEL_RESEARCHER", DEFAULT_MODEL_CONFIG.grounding_researcher),
};
...
export const culturalResearchService = new CulturalResearchService(culturalStore, llmClient, retrievalService);
