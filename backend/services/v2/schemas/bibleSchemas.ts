          ...
          properties: {
            ...
            psychological_profile: {
              ...
              properties: {
                ...
                speech_card: {
                  type: "object",
                  description: "How this character speaks — tendencies, not rules",
                  properties: {
                    typical_length: { type: "string", description: "short (1-8 words), medium (8-15), or long (15+) — their default sentence length in dialogue" },
                    under_pressure: { type: "string", description: "How their speech changes when stressed or cornered — fragments? retreats to formality? gets louder? goes silent?" },
                    never_articulates: { type: "string", description: "What this character CANNOT or WILL NOT say directly — their blind spot or emotional wall" },
                    deflection_style: { type: "string", description: "How they avoid answering — logistics? counter-questions? subject change? silence?" },
                  },
                  required: ["typical_length", "under_pressure", "never_articulates", "deflection_style"],
                  additionalProperties: false,
                },
              },
              required: ["want", "misbelief", "stress_style", "break_point", "voice_pattern", "speech_card"],
              additionalProperties: false,
            },
